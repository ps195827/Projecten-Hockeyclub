...
@section('content')
    ...
    <div class="form-group">
        <label>Moeilijkheidsgraad (aanpassen naar een lijst)</label>
        <input type="number" class="form-control" name="moeilijkheidsgraad">
    </div>
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name="makkelijker" id="content4"></textarea>
    </div>

    <div class="form-group">
        <label>Moeilijker maken</label>
        <textarea class="form-control" name="moeilijker" id="content4"></textarea>
    </div>
    ...
    <div class="form-group">
        ...
        <option value="" holder>Kies een minimaleveldoppervlakte</option>
...
<!-- <div class="form-group">
        <label>Doelgroep</label>
        <select class="form-control select2" multiple="" name="doelgroep_id">
        @foreach($doelgroep as $result)
            <option value="{{ $result->id }}">{{ $result->name }}</option>
            @endforeach
        </select>
